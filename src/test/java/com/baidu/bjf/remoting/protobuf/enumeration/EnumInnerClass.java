...
/**
 * The Class EnumInnerClass.
 */
public final class EnumInnerClass {
  
  /**
   * Instantiates a new enum inner class.
   */
  ...
  public static final class EnumClassInternal extends
    ...
    /* (non-Javadoc)
     * @see com.baidu.bjf.remoting.protobuf.enumeration.EnumInnerClass.EnumClassInternalOrBuilder#getStatus()
     */
     ...
     *
     * @param data the data
     * @return the com.baidu.bjf.remoting.protobuf.enumeration. enum inner class. enum class internal
     * @throws InvalidProtocolBufferException the invalid protocol buffer exception
     */
