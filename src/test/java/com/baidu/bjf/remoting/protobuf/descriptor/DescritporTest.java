...
public class DescritporTest {
    ...
    public void testPOJODescriptorWorksWell() throws IOException {
        Descriptor descriptor2 = com.baidu.bjf.remoting.protobuf.complexList.AddressBookProtos.AddressBook.getDescriptor();
    ...
    private byte[] getProtoBytes2() throws IOException {
        Codec<PersonPOJO> simpleMapPojoCodec = ProtobufProxy.create(PersonPOJO.class, false);
    ...
    public void testGetDescriptor() throws IOException {
        Codec<PersonPOJO> codec = ProtobufProxy.create(PersonPOJO.class, false);
        ...
        FieldDescriptor stringMapFD = descriptor.findFieldByName("name");
        ...
        Assert.assertEquals("xiemalin", field);
        
        Descriptor descriptor2 = AddressBookProtos.Person.getDescriptor();
        
        stringMapFD = descriptor2.findFieldByName("name");
